describe User do
  ...
  context 'User relationship to Post' do
    ...
    let!(:post1) { Post.create(user_id: user.id, post_name: 'post1', post_content: 'content1') }
    let!(:post2) { Post.create(user_id: user.id, post_name: 'post2', post_content: 'contente2') }
